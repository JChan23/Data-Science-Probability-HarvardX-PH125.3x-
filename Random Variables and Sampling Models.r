...
#Each red and black pocket is associated with a number from 1 to 36. The two remaining green slots feature "0" and "00". 
...
X <- sample(c(-1, 17), n, replace=TRUE, c(p_not_green, p_green))
